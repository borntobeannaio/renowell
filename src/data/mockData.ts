...
export const mockNews: NewsItem[] = [
  {
    id: "n1",
    kind: "news",
    title: "Портал Реновель близится к запуску",
    body: "Рады сообщить, что внутренний портал компании Реновель находится на финальной стадии разработки. Совсем скоро все сотрудники смогут пользоваться новыми возможностями для эффективной работы и коммуникации.",
